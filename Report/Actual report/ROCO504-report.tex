...
\subsubsection{Motors}\label{gearbox_sol}
...
To address the problem discussed in \ref{force_problem}, clamps were designed to lock each cord in place.
...
\subsection{Redesign}
\subsubsection{Motor velocities}

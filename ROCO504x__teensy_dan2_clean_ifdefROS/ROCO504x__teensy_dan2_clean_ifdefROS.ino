...
void loop() {
  ...
  if (currentMillis - previousMillis > lInterval) {
    ...
    ((camX < 0) && (current_x <= minX)) ? endstop1 = 1.0 : endstop1 = 0.0;
    ((camX > 0) && (current_x >= maxX)) ? endstop2 = 1.0 : endstop2 = 0.0;
    ((camY < 0) && (current_y <= minY)) ? endstop3 = 1.0 : endstop3 = 0.0;
    ((camY > 0) && (current_y >= maxY)) ? endstop4 = 1.0 : endstop4 = 0.0;
...
void endStopCal(void) {
  ...
  if (((camX < 0) && (current_x <= minX)) || ((camX > 0) && (current_x >= maxX)) || ((camY < 0) && (current_y <= minY)) || ((camY > 0) && (current_y >= maxYstop))) {
    endStop = true;
...
void messageCb( const geometry_msgs::Point& data) {
  camX = 70.07 * (data.z - 160) / 320;
  camY = 70.07 * (120 - data.y) / 240;
  ball_detected = 0;
...
void twistMessageCb( const geometry_msgs::Twist& data) {
  ...
  camX = 70.07 * (x_dir - 160) / 320;
  camY = 70.07 * (y_dir - 120) / 240;

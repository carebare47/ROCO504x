...
int main(int argc, char **argv)
{
	...
	ros::NodeHandle n;
	geometry_msgs::PointStamped timer1b;
	geometry_msgs::PointStamped timer2b;
	ros::Publisher timer1 = n.advertise<geometry_msgs::PointStamped>("/timer1", 1);
	ros::Publisher timer2 = n.advertise<geometry_msgs::PointStamped>("/timer2", 1);
